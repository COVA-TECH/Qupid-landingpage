...
export default function Footer() {
	...
	return (
		<footer className="py-10 bg-primary text-white">
			<div className="flex flex-col items-center  text-white py-20  h-full relative z-2 px-2 gap-5">
			...
			<div className="mx-auto max-w-5xl px-6">
				...
				<div className="my-8 flex flex-wrap justify-center gap-6 text-sm text-white z-10 relative">
				...
				<span className=" block text-center text-sm">
					{" "}
					© {new Date().getFullYear()} COVA Technologies, All rights reserved
				</span>
			</div>
		</footer>
	);
